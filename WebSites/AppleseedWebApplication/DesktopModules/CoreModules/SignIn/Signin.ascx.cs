...
namespace Appleseed.Content.Web.Modules
{
    ...
    public partial class Signin : PortalModuleControl
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            // 				this.Visible = false;
            this.LoginBtn.Click += this.LoginBtn_Click;
            this.SendPasswordBtn.Click += this.SendPasswordBtn_Click;
            this.RegisterBtn.Click += this.RegisterBtn_Click;
            base.OnInit(e);
        }
        ...
        private void SendPasswordBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                this.Message.Text = "Please enter you email address";
            ...
            if (memberUser != null)
            {
                ...
                var LoginUrl = Path.ApplicationFullPath + "DesktopModules/Admin/Logon.aspx?Usr=" + Name + "&Pwd=" +
                ...
                if (this.portalSettings.CustomSettings["SITESETTINGS_ON_REGISTER_SEND_FROM"] != null)
                {
                    ...
                    catch
                    {
                        ...
                        LogHelper.Logger.Log(
                            LogLevel.Warn, 
                            string.Format(
                                "This is the current email address used as sender when someone want to retrieve his/her password: '{0}'. Is not well formed. Check the setting SITESETTINGS_ON_REGISTER_SEND_FROM of portal '{1}' in order to change this value (it's a portal setting).", 
                                mailFrom, 
