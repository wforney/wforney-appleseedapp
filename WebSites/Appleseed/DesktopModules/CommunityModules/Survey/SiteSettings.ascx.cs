...
namespace Appleseed.Content.Web.Modules
{
    ...
    public class SiteSettings : PortalModuleControl 
    {
        ...
        {
            PortalSettings.UpdatePortalSetting(portalSettings.PortalID, ((SettingItem<string, TextBox>)e.CurrentItem).EditControl.ID, ((SettingItem<string, TextBox>)e.CurrentItem).Value);        
        }
