...
<%@ Page AutoEventWireup="false" Inherits="Appleseed.Content.Web.Modules.Discussion.DiscussionEdit"
                ...
                <table border="0" cellpadding="4" cellspacing="0" width="600">
                    <tr valign="top">
                        <td class="SubHead" width="150">
                            <rbfwebui:label id="title_label" runat="Server" text="Subject" textkey="SUBJECT">
                            </rbfwebui:label>
                        </td>
                        <td rowspan="4">
                            &nbsp;
                    ...
                    <tr valign="top">
                        <td class="SubHead">
                            <rbfwebui:label id="body_label" runat="Server" text="Body" textkey="DS_BODY">
                            </rbfwebui:label>
                        </td>
                        <td width="*">
