            ...
            try
            {
                while ( dr.Read())
                {
                    ...
                    if(dr["FieldType"].ToString() == "Image")
                    {
                        ...
                        ((BoundColumn)colField).DataFormatString = string.Format("<img src=\"{0}/{{0}}\" alt=\"{{0}}\" border =0>", ((SettingItem<string, TextBox>)this.Settings["ImagePath"]).FullPath) ;
                    }
                    else if(dr["FieldType"].ToString() == "File")
                    {
                        ...
                        ((HyperLinkColumn)colField).DataNavigateUrlFormatString = string.Format("{0}/{{0}}", ((SettingItem<string, TextBox>) this.Settings["DocumentPath"]).FullPath);
