...
Ver 1.1 - 07 Okt 2003 - Moved to seperate folder by [mario@hartmann.net]


Issues and Known problems:
- Tested with Appleseed version 1.2.8.1738 - 07 Okt 2003


Module settings
---------------
Hide automatically - when set, the module will disappear when user is loged on