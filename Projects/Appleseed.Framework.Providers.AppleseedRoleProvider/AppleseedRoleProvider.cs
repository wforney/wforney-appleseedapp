...
namespace Appleseed.Framework.Providers.AppleseedRoleProvider {
    ...
    public abstract class AppleseedRoleProvider : RoleProvider {
        ...
        /// <exception cref="AppleseedRoleProviderException">RenameRole throws an exception if there was an unexpected error 
        ...
        /// </summary>
        /// <param name="portalAlias">Appleseed's portal alias</param>
        /// <returns>A list of <code>AppleseedRole</code> objects</returns>
        ...
        /// <summary>
        /// Retrieves a <code>AppleseedRole</code> given a role name
        /// </summary>
        /// <param name="portalAlias">Appleseed's portal alias</param>
        /// <param name="roleName">The role name</param>
        /// <returns>A <code>AppleseedRole</code></returns>
        ...
        /// <summary>
        /// Retrieves a <code>AppleseedRole</code> given a role id
        /// </summary>
        /// <param name="roleId">A role id</param>
        /// <returns>A <code>AppleseedRole</code></returns>
        /// <exception cref="ProviderException">GetRole throws a ProviderException if the role doesn't exist</exception>
