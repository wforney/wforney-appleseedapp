...
*/
        ...
        /// The event source.
        /// </summary>
        private const string EventSource = "AppleseedSqlMembershipProvider";
*/
            ...
            out MembershipCreateStatus status)
        {
            return this.CreateUser(
                this.ApplicationName, username, password, email, passwordQuestion, passwordAnswer, approved, out status);
        }
            ...
            try
            {
                ...
                using (reader = cmd.ExecuteReader())
                {
                    if (reader.HasRows)
                    {
                        ...
                        var approved = reader.IsDBNull(3) ? false : reader.GetBoolean(3);
                        ...
                        var lockedOut = reader.IsDBNull(9) ? false : reader.GetBoolean(9);
        ...
        public override string ResetPassword(string portalAlias, string username, string answer)
        {
            ...
            var passwordSalt = string.Empty;
            string encodedPassword = this.PasswordFormat == MembershipPasswordFormat.Hashed ? this.EncodePassword(passwordSalt + newPassword) : this.EncodePassword(newPassword);
        ...
        public override bool ValidateUser(string portalAlias, string username, string password)
        {
            ...
            try
            {
                ...
                return this.CheckPassword(password, dbpassword, passwordSalt, passwordFormat);
            }
            catch (SqlException e)
            {
                if (this.WriteExceptionsToEventLog)
        ...
        protected virtual AppleseedUser GetUserFromReader(SqlDataReader reader)
        {
            ...
            var approved = reader.IsDBNull(4) ? false : reader.GetBoolean(4);
            ...
            var lockedOut = reader.IsDBNull(10) ? false : reader.GetBoolean(10);
        ...
        /// <summary>
        /// A helper function to retrieve configuration values from the configuration file.
        /// </summary>
        ...
        private string UnEncodePassword(string encodedPassword)
        {
            ...
            switch (this.PasswordFormat)
            {
                ...
                case MembershipPasswordFormat.Encrypted:
                    ...
                    break;
                case MembershipPasswordFormat.Hashed:
                    throw new AppleseedMembershipProviderException("Cannot decode a hashed password.");
                default:
                    throw new AppleseedMembershipProviderException("Unsupported password format.");
            }
