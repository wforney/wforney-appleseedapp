...
namespace Appleseed.Framework.Providers.AppleseedMembershipProvider {
    ...
    public abstract class AppleseedMembershipProvider : MembershipProvider {
        ...
        /// <returns></returns>
        protected virtual AppleseedUser InstanciateNewUser( string providerName, string name, Guid providerUserKey, string email, string passwordQuestion, 
            ...
            return new AppleseedUser( providerName, name, providerUserKey, email, passwordQuestion, 
        ...
        /// </summary>
        /// <param name="user">A <code>AppleseedMembershipUser</code> with most of the user's data</param>
        ...
        public virtual MembershipUser CreateUser( AppleseedUser user, string password, string passwordAnswer ) {
            ...
            AppleseedUser membershipUser = ( AppleseedUser )CreateUser( user.UserName, password, user.Email, user.PasswordQuestion, passwordAnswer, user.IsApproved, user.ProviderUserKey, out status );
            if ( user != null ) {
