...
namespace Massive
{
    ...
    public class DynamicModel
    {
        ...
        public DynamicModel(string connectionStringName = "", string tableName = "", string tableNamePrefix = "", string primaryKeyField = "")
        {
            TableName = tableName == "" ? tableNamePrefix + this.GetType().Name : tableNamePrefix + tableName;
